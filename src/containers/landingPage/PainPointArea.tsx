...
const PainPointArea = () => {
  return (
    <div
      className={`w-full flex flex-col items-center gap-4 ${universalPaddingX}`}
    >
      <h3 className="dark:text-dark_primary_text text-2xl sm:text-3xl text-center max-w-[900px] font-medium">
        {
          "Did You know that about 70% of candidates get rejected based on their Resumes?, Crazy right?"
        }
      </h3>
      <p className="dark:text-dark_secondary_text xl:max-w-[90%] dark:font-normal font-medium text-base md:text-lg">{`Don’t let that scare you, We’ve created a platform where you can have access to the best Resources, Technologies and Professionals that can help you build the perfect resume to land that amazing position. 
